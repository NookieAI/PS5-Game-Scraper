...
A desktop application built with Electron that scrapes PS5 game data, extracting Akira and Viking download links for easy access to game updates and patches.
